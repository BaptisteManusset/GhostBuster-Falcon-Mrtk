...
public class FalconMain : MonoBehaviour
{
    ...
    [Space(30)] public Vector3 godPos;
    ...
    void Update()
    {
        ...
        #region MyRegion
        FalconUnity.getGodPosition(num_falcons, out godPos);
        FalconUnity.getTipPosition(num_falcons, out tipPos);
