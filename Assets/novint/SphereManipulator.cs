...
public class SphereManipulator : MonoBehaviour
{
    ...
    public void ChangePosition()
    {
        ...
        Vector3 tipPositionScale = moveposition;

        Debug.Log("" + tipPositionScale + " > " + tipPositionScale);
        tipPositionScale *= hapticTipToWorldScale;

        FalconUnity.updateHapticTransform(falcon_num, transform.position, transform.rotation, tipPositionScale, useMotionCompensator, 3);
